...
//CODE FOR ASSIGNING A COLOR
// let indexOfFirstBrighterColor = 0;
// while (indexOfFirstBrighterColor < colors.length && cumulativeBrightness < colors[indexOfFirstBrighterColor].squareBrightness()) {
//     indexOfFirstBrighterColor++;
// }
// let color;
// if (indexOfFirstBrighterColor === 0) {
...
// }
// else {
//     const t = (Math.sqrt(cumulativeBrightness) - Math.sqrt(colors[indexOfFirstBrighterColor - 1].squareBrightness()))
//         / (Math.sqrt(colors[indexOfFirstBrighterColor].squareBrightness()) - Math.sqrt(colors[indexOfFirstBrighterColor - 1].squareBrightness()));
//     if (Math.random() < t)
//         color = colors[indexOfFirstBrighterColor];
//     else
